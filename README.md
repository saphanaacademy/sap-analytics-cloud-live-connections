...
Code snippets, information and documentation links for the tutorial video playlist. 

### Tutorial Video Playlist ### 
[SAP Analytics Cloud Live Connection](https://www.youtube.com/playlist?list=PLkzo92owKnVxm3TMoUliy5b5UO1G5GP50)

## Live Connections ##
There are many different types of connections we can make from SAP Analytics Cloud. In this series, we cover a live connection to SAP HANA using the Information Access (InA) Service. This service is exposed by SAP HANA XS (classic) and requires the following configuration before the connection can be established. 
